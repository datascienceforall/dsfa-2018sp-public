...
CorrectTable = """Number of petals | Name
8                | lotus
34               | sunflower
5                | rose
10               | lavender
...
def check3_2(seven_flowers):
	if isinstance(seven_flowers,Table):
		StudentTable = seven_flowers.take([0,1,2,4,5,6])
		ATable = string_to_table(CorrectTable)
		if not CheckTables(StudentTable,ATable,sort = False):
